...
void map_notify_handler(XEvent local_event, Display* display, ScreenInfos infos){
    ...
    if(child_name!=NULL){
        if(strcmp(child_name, "Parent") && local_event.xmap.override_redirect == False){
            ...
            draw_controls(display, new_win, win_attr, BlackPixel(display, infos.screen_num), WhitePixel(display, infos.screen_num), CONTROL_RIGHT);
            draw_controls(display, new_win, win_attr, BlackPixel(display, infos.screen_num), WhitePixel(display, infos.screen_num), CONTROL_CENTER);
            draw_controls(display, new_win, win_attr, BlackPixel(display, infos.screen_num), WhitePixel(display, infos.screen_num), CONTROL_LEFT);
